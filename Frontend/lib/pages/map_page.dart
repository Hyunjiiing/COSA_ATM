...
List<Marker> _markers = [
  Marker(
      markerId: MarkerId("맨홀1"),
      draggable: true,
      position: LatLng(36.6305, 127.4578),
      infoWindow: InfoWindow(title: "1234")),
  Marker(
      markerId: MarkerId("전봇대1"),
      draggable: true,
      position: LatLng(36.6299, 127.4590),
      infoWindow: InfoWindow(title: "5678"))
];
...
class _MapPageState extends State<MapPage> {
            ...
            child: MaterialButton(
              child: Container(
                ...
                child: Row(
                  ...
                  children: [Icon(Icons.location_on_outlined), Text("내 위치")],
                ),
              ),
  ...
  Future<void> _goToTheMyLocation() async {
    ...
    controller.animateCamera(CameraUpdate.newCameraPosition(CameraPosition(
        target: LatLng(current_latitude, current_longitude), zoom: 15)));
