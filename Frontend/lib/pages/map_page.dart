...
List<Marker> _markers = [
  ...
  Marker(markerId: MarkerId("전봇대1"),draggable: true,position: LatLng(36.6295, 127.4499),infoWindow: InfoWindow(title: "5678"),icon: BitmapDescriptor.fromBytes(markerIcon))
];
